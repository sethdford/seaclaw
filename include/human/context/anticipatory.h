 ...
 * Format: "[ANTICIPATORY: [Name]'s kid has a game tomorrow — she may be nervous. Consider checking in.]"
 * Only includes predictions with confidence > 0.5. Caller owns returned string. */
