...
- minimal binary size (~544 KB release with LTO)
...
Current scale: **599 source + header files, ~105K lines of C, ~46K lines of tests, 3207 tests, 33 channels**.
...
2. **Binary size and memory are hard product constraints**
   ...
   - Current release binary: ~544 KB (all features with LTO).
...
5. **All 3207+ tests must pass at zero ASan errors**
