...
typedef struct hu_tool_result {
    ...
    const char *media_path;     /* optional: local file path for generated media (images, video, GIF) */
    size_t media_path_len;
    bool media_path_owned;
} hu_tool_result_t;
...
static inline hu_tool_result_t hu_tool_result_ok_with_media(const char *output, size_t output_len,
