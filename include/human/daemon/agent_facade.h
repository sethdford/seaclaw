/* Daemon agent subsystem facade — aggregates agent module headers used by daemon.c */
#ifndef HU_DAEMON_AGENT_FACADE_H
#define HU_DAEMON_AGENT_FACADE_H
...
#endif /* HU_DAEMON_AGENT_FACADE_H */
