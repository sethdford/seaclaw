...
```
~1696 KB binary · <30 ms startup · 6359+ tests · 97 providers · 38 channels (37 production + 1 experimental) · 85 tools · Pluggable everything
```
...
Tests:         6359+ passing, 0 ASan errors
```
