...
static void ensemble_consensus_chat_with_system_picks_longest(void) {
    hu_allocator_t alloc = hu_system_allocator();
...
static void ensemble_consensus_chat_picks_longest_content(void) {
    hu_allocator_t alloc = hu_system_allocator();
...
void run_ensemble_tests(void) {
    ...
    HU_RUN_TEST(ensemble_consensus_chat_with_system_picks_longest);
    HU_RUN_TEST(ensemble_consensus_chat_picks_longest_content);
