...
<p align="center">
  ...
  <strong>~1750 KB binary. < 6 MB RAM. Boots in <30 ms. Runs on anything with a CPU.</strong>
</p>
...
- **Impossibly Small:** ~1750 KB static binary — no runtime, no VM, no framework overhead.
...
| **RAM** ¹         | —                                                | —                                           | < 10 MB                                        | < 5 MB                                                | **< 6 MB**        |
| **Binary Size** ¹ | ~28 MB (npm dist)                                | N/A (Python)                                | ~8 MB                                          | ~8.8 MB                                               | **~1750 KB**      |
...
Test files: 336
Tests: 6374+
Binary: ~1750 KB (MinSizeRel + LTO, all channels)
Peak RSS: ~5.7 MB
