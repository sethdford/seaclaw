...
public enum SCTokens {
    ...
    public enum Dark {
        ...
        public static let bgElevated = Color(hex: 0x162230)
        public static let bgInset = Color(hex: 0x0B1219)
        public static let bgOverlay = Color(hex: 0x1C2A3A)
        public static let bgSurface = Color(hex: 0x101A24)
        public static let border = Color(hex: 0x233345)
        public static let borderSubtle = Color(hex: 0x162230)
        ...
        public static let textMuted = Color(hex: 0x5E7A94)
