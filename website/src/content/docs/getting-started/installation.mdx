---
title: Installation
description: Install Human on macOS or Linux. Mac users get on-device AI with zero configuration.
---
...
**Homebrew:** `brew install --HEAD ./Formula/human.rb` | **Docker:** `docker pull ghcr.io/sethdford/h-uman:latest` | **Nix:** `nix run github:sethdford/h-uman`
:::
