...
- minimal binary size (~1620 KB release with LTO)
...
Current scale: **1233 source + header files, ~290K lines of C, ~120K lines of tests, 7076 tests, 38 channels**.
...
2. **Binary size and memory are hard product constraints**
   ...
   - Current release binary: ~1620 KB (all features with LTO).
...
5. **All 7076+ tests must pass at zero ASan errors**
