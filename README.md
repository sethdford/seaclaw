...
```
~500 KB binary · <30 ms startup · 2,768 tests · 50+ providers · 33 channels · 73 tools · Pluggable everything
```
...
Tests:         2,768 passing, 0 ASan errors
```
...
tests/ 94 test files, 2,768 tests
