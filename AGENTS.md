...
- minimal binary size (~1604 KB release with LTO)
...
Current scale: **1228 source + header files, ~285K lines of C, ~118K lines of tests, 6953 tests, 38 channels**.
...
2. **Binary size and memory are hard product constraints**
   ...
   - Current release binary: ~1604 KB (all features with LTO).
...
5. **All 6953+ tests must pass at zero ASan errors**
