...
- minimal binary size (~1571 KB release with LTO)
...
Current scale: **1215 source + header files, ~279K lines of C, ~117K lines of tests, 6852 tests, 38 channels**.
...
2. **Binary size and memory are hard product constraints**
   ...
   - Current release binary: ~1571 KB (all features with LTO).
...
5. **All 6852+ tests must pass at zero ASan errors**
