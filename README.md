...
```
~500 KB binary · <30 ms startup · 2853 tests · 50+ providers · 33 channels · 73 tools · Pluggable everything
```
...
Tests:         2853 passing, 0 ASan errors
```
...
tests/ 92 test files, 2853 tests
