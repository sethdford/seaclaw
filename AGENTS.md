...
Current scale: **587 source + header files, ~98K lines of C, ~38K lines of tests, 2,678 tests, 33 channels**.
...
5. **All 2,678+ tests must pass at zero ASan errors**
...
tests/                 91 test files, 2,678+ tests
