...
Current scale: **1,054 source + header files, ~192K lines of C, ~98K lines of tests, 6051+ tests, 38 channels**.
...
5. **All 6051+ tests must pass at zero ASan errors**
...
tests/                 291 test files, 6051+ tests
