...
#include <stdbool.h>
#include <stddef.h>
typedef struct hu_voice_rt_config { char *model; char *voice; int sample_rate; bool vad_enabled; } hu_voice_rt_config_t;
typedef struct hu_voice_rt_session { hu_allocator_t *alloc; hu_voice_rt_config_t config; bool connected; char *session_id; } hu_voice_rt_session_t;
