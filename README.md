...
<p align="center">
  ...
  <strong>~1506 KB binary. < 6 MB RAM. Boots in <30 ms. Runs on anything with a CPU.</strong>
</p>
...
- **Impossibly Small:** ~1506 KB static binary — no runtime, no VM, no framework overhead.
...
- **Feature-Complete:** 50+ providers, 33 channels, 67+ tools, hybrid vector+FTS5 memory, multi-layer sandbox, tunnels, hardware peripherals, MCP, subagents, streaming, voice — the full stack.
