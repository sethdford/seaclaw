...
```
~1604 KB binary · <30 ms startup · 6953+ tests · 97 providers · 38 channels (37 production + 1 experimental) · 85 tools · Pluggable everything
```
...
tests/ 335 test files, 6953 tests
