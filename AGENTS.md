...
- minimal binary size (~560 KB release with LTO)
...
Current scale: **615 source + header files, ~109K lines of C, ~47K lines of tests, 3207 tests, 33 channels**.
...
2. **Binary size and memory are hard product constraints**
   ...
   - Current release binary: ~560 KB (all features with LTO).
