...
public enum HUTokens {
    ...
    public enum Dark {
        ...
        public static let accentTertiary = Color(hex: 0x6366F1)
        public static let accentTertiaryHover = Color(hex: 0x818CF8)
        public static let accentTertiaryStrong = Color(hex: 0xA5B4FC)
        public static let accentTertiarySubtle = Color(red: 0.3882, green: 0.4, blue: 0.9451, opacity: 0.14)
        ...
        public static let focusOverlay = Color(red: 0.4784, green: 0.7137, blue: 0.2824, opacity: 0.12)
        public static let focusRing = Color(hex: 0x7AB648)
        public static let hoverOverlay = Color(red: 0.4784, green: 0.7137, blue: 0.2824, opacity: 0.08)
    ...
    public enum Light {
        ...
        public static let accentTertiary = Color(hex: 0x4F46E5)
        public static let accentTertiaryHover = Color(hex: 0x4338CA)
        public static let accentTertiaryStrong = Color(hex: 0x6366F1)
        public static let accentTertiarySubtle = Color(red: 0.3098, green: 0.2745, blue: 0.898, opacity: 0.1)
        public static let accentTertiaryText = Color(hex: 0x4338CA)
        public static let accentText = Color(hex: 0x47802A)
        ...
        public static let focusOverlay = Color(red: 0.3529, green: 0.6039, blue: 0.1882, opacity: 0.1)
        public static let focusRing = Color(hex: 0x5A9A30)
        public static let hoverOverlay = Color(red: 0.3529, green: 0.6039, blue: 0.1882, opacity: 0.06)
        ...
        public static let linkActive = Color(hex: 0x7AB648)
        public static let linkHover = Color(hex: 0x47802A)
        public static let linkVisited = Color(hex: 0x47802A)
        public static let onAccent = Color(hex: 0xFFFFFF)
