...
C11 autonomous AI assistant runtime. ~544 KB binary, <6 MB RAM, <30 ms startup.
...
# Run tests (3207+ tests, must be 0 failures, 0 ASan errors)
./build/seaclaw_tests
...
| Path               | What                                           |
| ------------------ | ---------------------------------------------- |
| `src/`             | All C source (~609 files, ~108K lines)         |
